...
with IndentFlag():
    ...
    run_cmd = "docker run {opt} --name {name} {network} {ip} {mount_volumes} {image} {command}".format(
        ...
        command=r"mongos --bind_ip 0.0.0.0 --port 27017 --logpath /root/zone/zone_1/mongos/zone_1_mongos_1/log.txt --configdb rs_cfg/10.0.1.189:27017,10.0.1.190:27017,10.0.1.191:27017"
    )
    ret, out_txt, error_txt = paramiko_ssh_cmd(ssh_client, run_cmd, exit_when_error=True)
    if 0 != ret:
        print("docker run: run docker container fail, cmd is {0}\n exit_code is {1}\n out is {2}\n error is {3}".format(run_cmd, ret, out_txt, error_txt))
...
with IndentFlag():
    ...
    if 0 != ret:
        ...
        sys.exit(ret)
    # execute cmds in docker contianer
    ret, out_txt, error_txt = paramiko_ssh_cmd(ssh_client, "docker exec {name} {command}".format(name=ct_name, command=''' mongosh --host 10.0.1.192 --port 27017  --eval 'rs.initiate({ _id:\"rs_db_1\", members:[ {_id:0, host:\"10.0.1.192:27017\"},{_id:1, host:\"10.0.1.193:27017\"},{_id:2, host:\"10.0.1.194:27017\"} ] }); rs.secondaryOk()' '''))
    if 0 != ret:
        print("docker exec: run cmd fail, exit_code is {0}\nstd_out is {1}\nstd_error is {2}\n-------------\n".format(ret, out_txt, error_txt))
    else:
        print("docker exec: run cmd succ, exit_code is {0}\nstd_out is {1}\nstd_error is {2}\n-------------\n".format(ret, out_txt, error_txt))
    ret, out_txt, error_txt = paramiko_ssh_cmd(ssh_client, "docker exec {name} {command}".format(name=ct_name, command=''' mongosh --host 10.0.1.198 --port 27017  --eval 'rs.initiate({ _id:\"rs_db_3\", members:[ {_id:0, host:\"10.0.1.198:27017\"},{_id:1, host:\"10.0.1.199:27017\"},{_id:2, host:\"10.0.1.200:27017\"} ] }); rs.secondaryOk()' '''))
    if 0 != ret:
        print("docker exec: run cmd fail, exit_code is {0}\nstd_out is {1}\nstd_error is {2}\n-------------\n".format(ret, out_txt, error_txt))
    else:
        print("docker exec: run cmd succ, exit_code is {0}\nstd_out is {1}\nstd_error is {2}\n-------------\n".format(ret, out_txt, error_txt))
    ret, out_txt, error_txt = paramiko_ssh_cmd(ssh_client, "docker exec {name} {command}".format(name=ct_name, command=''' mongosh --host 10.0.1.195 --port 27017  --eval 'rs.initiate({ _id:\"rs_db_2\", members:[ {_id:0, host:\"10.0.1.195:27017\"},{_id:1, host:\"10.0.1.196:27017\"},{_id:2, host:\"10.0.1.197:27017\"} ] }); rs.secondaryOk()' '''))
    if 0 != ret:
        print("docker exec: run cmd fail, exit_code is {0}\nstd_out is {1}\nstd_error is {2}\n-------------\n".format(ret, out_txt, error_txt))
    else:
        print("docker exec: run cmd succ, exit_code is {0}\nstd_out is {1}\nstd_error is {2}\n-------------\n".format(ret, out_txt, error_txt))
    ret, out_txt, error_txt = paramiko_ssh_cmd(ssh_client, "docker exec {name} {command}".format(name=ct_name, command=''' mongosh --host 10.0.1.189 --port 27017  --eval 'rs.initiate({ _id:\"rs_cfg\", members:[ {_id:0, host:\"10.0.1.189:27017\"},{_id:1, host:\"10.0.1.190:27017\"},{_id:2, host:\"10.0.1.191:27017\"} ] }); rs.secondaryOk()' '''))
    if 0 != ret:
        print("docker exec: run cmd fail, exit_code is {0}\nstd_out is {1}\nstd_error is {2}\n-------------\n".format(ret, out_txt, error_txt))
    else:
        print("docker exec: run cmd succ, exit_code is {0}\nstd_out is {1}\nstd_error is {2}\n-------------\n".format(ret, out_txt, error_txt))
...
with IndentFlag():
    ...
    if 0 != ret:
        ...
        sys.exit(ret)
    # execute cmds in docker contianer
    ret, out_txt, error_txt = paramiko_ssh_cmd(ssh_client, "docker exec {name} {command}".format(name=ct_name, command=''' mongosh --host 10.0.1.201 --port 27017  --eval 'sh.addShard(\"rs_db_1/10.0.1.192:27017,10.0.1.193:27017,10.0.1.194:27017\")' '''))
    if 0 != ret:
        print("docker exec: run cmd fail, exit_code is {0}\nstd_out is {1}\nstd_error is {2}\n-------------\n".format(ret, out_txt, error_txt))
    else:
        print("docker exec: run cmd succ, exit_code is {0}\nstd_out is {1}\nstd_error is {2}\n-------------\n".format(ret, out_txt, error_txt))
    ret, out_txt, error_txt = paramiko_ssh_cmd(ssh_client, "docker exec {name} {command}".format(name=ct_name, command=''' mongosh --host 10.0.1.201 --port 27017  --eval 'sh.addShard(\"rs_db_3/10.0.1.198:27017,10.0.1.199:27017,10.0.1.200:27017\")' '''))
    if 0 != ret:
        print("docker exec: run cmd fail, exit_code is {0}\nstd_out is {1}\nstd_error is {2}\n-------------\n".format(ret, out_txt, error_txt))
    else:
        print("docker exec: run cmd succ, exit_code is {0}\nstd_out is {1}\nstd_error is {2}\n-------------\n".format(ret, out_txt, error_txt))
    ret, out_txt, error_txt = paramiko_ssh_cmd(ssh_client, "docker exec {name} {command}".format(name=ct_name, command=''' mongosh --host 10.0.1.201 --port 27017  --eval 'sh.addShard(\"rs_db_2/10.0.1.195:27017,10.0.1.196:27017,10.0.1.197:27017\")' '''))
    if 0 != ret:
        print("docker exec: run cmd fail, exit_code is {0}\nstd_out is {1}\nstd_error is {2}\n-------------\n".format(ret, out_txt, error_txt))
    else:
        print("docker exec: run cmd succ, exit_code is {0}\nstd_out is {1}\nstd_error is {2}\n-------------\n".format(ret, out_txt, error_txt))
    ret, out_txt, error_txt = paramiko_ssh_cmd(ssh_client, "docker exec {name} {command}".format(name=ct_name, command=''' mongosh --host 10.0.1.201 --port 27017 admin --eval 'db.createUser({ "user":"root", "pwd":"xiaolzz", "roles":["root"] })' '''))
    if 0 != ret:
        print("docker exec: run cmd fail, exit_code is {0}\nstd_out is {1}\nstd_error is {2}\n-------------\n".format(ret, out_txt, error_txt))
    else:
        print("docker exec: run cmd succ, exit_code is {0}\nstd_out is {1}\nstd_error is {2}\n-------------\n".format(ret, out_txt, error_txt))
    ret, out_txt, error_txt = paramiko_ssh_cmd(ssh_client, "docker exec {name} {command}".format(name=ct_name, command=''' mongosh --host 10.0.1.201 --port 27017 admin --eval 'db.createUser({ "user":"lxl", "pwd":"xiaolzz", "roles":[ { role: "readWriteAnyDatabase", db: "admin" } ] })' '''))
    if 0 != ret:
        print("docker exec: run cmd fail, exit_code is {0}\nstd_out is {1}\nstd_error is {2}\n-------------\n".format(ret, out_txt, error_txt))
    else:
        print("docker exec: run cmd succ, exit_code is {0}\nstd_out is {1}\nstd_error is {2}\n-------------\n".format(ret, out_txt, error_txt))
...
with IndentFlag():
    ...
    run_cmd = "docker run {opt} --name {name} {network} {ip} {mount_volumes} {image} {command}".format(
        opt="-d", name="zone_1_mongos_1", network=opt_network, ip=opt_ip, mount_volumes=" ".join(opt_mount_volumes), image="lxl_debian",
        command=r"mongos --bind_ip 0.0.0.0 --port 27017 --keyFile /root/zone/zone_1/mongos/zone_1_mongos_1/id_key_file --logpath /root/zone/zone_1/mongos/zone_1_mongos_1/log.txt --configdb rs_cfg/10.0.1.189:27017,10.0.1.190:27017,10.0.1.191:27017"
    )
    ret, out_txt, error_txt = paramiko_ssh_cmd(ssh_client, run_cmd, exit_when_error=True)
    if 0 != ret:
        print("docker run: run docker container fail, cmd is {0}\n exit_code is {1}\n out is {2}\n error is {3}".format(run_cmd, ret, out_txt, error_txt))
