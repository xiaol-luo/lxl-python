...
with IndentFlag():
    ...
    ret, out_txt, error_txt = paramiko_ssh_cmd(ssh_client, "docker exec {name} {command}".format(name=ct_name, command=''' etcdctl  --username zone_1:zone_1 --endpoints //10.0.1.193:2379,//10.0.1.194:2379,//10.0.1.195:2379 ls / '''))
    if 0 != ret:
